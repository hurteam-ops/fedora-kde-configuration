...
echo -e "  1. ${YELLOW}Open a NEW terminal window${NC} (do NOT run 'exec zsh')"
echo -e "  2. Or ${YELLOW}reboot${NC} / log out and select KDE Plasma"
echo -e "  3. Set your wallpaper: ${CYAN}System Settings → Appearance → Wallpaper${NC}"
echo -e "  4. Generate dynamic theme: ${CYAN}matugen image ~/wallpaper.jpg${NC}"
echo -e "  5. Run ${CYAN}fetch${NC} to show system info"
echo -e "  6. Run ${CYAN}qcopy${NC} to copy files to clipboard"
echo ""
